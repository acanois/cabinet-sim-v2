...
BasicAmpSimAudioProcessor::BasicAmpSimAudioProcessor()
    ...
    : AudioProcessor(BusesProperties()
      ...
      mValueTree(*this, nullptr, "ValueTree", {
                     std::make_unique<juce::AudioParameterFloat>("input", "Input",
                                                                 juce::NormalisableRange<float>(0.f, 2.f, 0.001f),
                                                                 mInput.get()),
                     std::make_unique<juce::AudioParameterFloat>("output", "Output",
                                                                 juce::NormalisableRange<float>(0.f, 2.f, 0.001f),
                                                                 mOutput.get())
                 }) {
    ...
    convolution.loadImpulseResponse(
        dir.getChildFile("YA MES 212 V30 Mix 01.wav"),
